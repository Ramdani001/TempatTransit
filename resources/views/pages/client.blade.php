        ...
        <table id="example" class="display" style="width:100%">
            ...
            @foreach($data as $client => $value)
                <tr>
                    ...
                    <td class="grid grid-flow-col gap-2 h-full">
                        <button id="btnEditClient" type="button" class="text-green-500 bg-white rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-toggle="crud-modal" value="{{ $value->client->id }}">
                        {{-- <button class="p-2 text-red-700 bg-white shadow-md rounded font-semibold active:scale-95"> --}}
                            <ion-icon name="open-outline"></ion-icon>
                        </button>
                        {{-- <button class="p-2 text-red-700 bg-white shadow-md rounded font-semibold active:scale-95"> --}}
                        <button id="btnHpusClient" data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="text-red-500 bg-white rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" type="button" value="{{ $value->client->id }}">
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-start justify-between p-4">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="crud-modal">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                    </svg>
                    <span class="sr-only">Close modal</span>
            ...
            <!-- Modal body -->
            <div class="relative flex flex-col align-content-center px-4 py-4">
              <form method="post" class="grid grid-cols-4 gap-4" action=" {{ '/admin/editClient' }} ">
                  @csrf
                  @method('post')
                  <input type="text" name="status" id="status" value="AksiEdit" hidden>
                  <input type="text" name="id_client" id="id_client" hidden>
                  <div class="col-span-2">
                      <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Client name</label>
                      <input type="text" name="name" id="nameEdit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="full name" required>
                  </div>
                  <div class="col-span-2">
                      <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Client email</label>
                      <input type="text" name="email" id="emailEdit" placeholder="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                  </div>
                  <div class="col-span-2">
                      <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Client phone</label>
                      <input type="text" name="phone" id="phoneEdit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="+62 xxxxxxxx" required>
                  </div>
                  <div class="col-span-2">
                      <label for="prices" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Prices</label>
                      <input type="text" name="prices" id="pricesEdit" placeholder="$999" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                  </div>
                  <div class="col-span-2">
                      <label for="address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address</label>
                      <textarea type="text" name="address" id="addressEdit" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Your address here"></textarea>
                  </div>
                  <div class="col-span-2">
                      <label for="details" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Details</label>
                      <textarea type="text" name="details" id="detailsEdit" id rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Details"></textarea>
                  </div>
                  <div class="col-span-1 ">
                      <label for="" class=""><br></label>
                      <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <form action="{{ '/admin/editClient' }}" method="post">
                    @csrf
                    <input type="text" name="status" id="status" value="AksiHapus" hidden>
                    <input type="text" name="idSendDel" id="idSendDel" hidden>
